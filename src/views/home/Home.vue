...
export default defineComponent({
  setup(){
    ...
    const getTableList=async()=>{
      await axios.get("/home/getData")//换成线上模拟的mockfast网址
      .then((res)=>{
       // console.log(res);
    ...
    let videoData=reactive({
      ...
      await axios.get("/home/getCharts").then((res)=>{
          let orderRes=res.data.data.orderData;
          let userRes=res.data.data.userData;
          let videoRes=res.data.data.videoData;
